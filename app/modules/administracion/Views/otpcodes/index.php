        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="user" value="<?php echo $this->getObjectVariable($this->filters, 'user') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>code</label>
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="date" value="<?php echo $this->getObjectVariable($this->filters, 'date') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
