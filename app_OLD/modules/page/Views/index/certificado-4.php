...
<table>
  ...
  <tr>
    <td class="">
      <p>
        El(la) Asociado(a) <?php echo $this->data['basic']->NombreCompleto ?> de Morales con Cédula de Ciudadanía <?php echo $this->data['basic']->Cedula ?>posee en
        el fondo los siguientes productos y saldos de crédito.
      </p>
      <br>
    </td>
  </tr>
